...
public class Management extends JFrame{
    ...
    public Management(String title) throws HeadlessException {
        ...
        cbModel.addElement("General Director ");
        cbModel.addElement("Director");
        cbModel.addElement("Department Manager");
        cbModel.addElement("Manager");
        cbModel.addElement("Employee");
        cbPosition.setModel(cbModel);
        ...
        tbCan.setModel(new DefaultTableModel(
                new Object[][]{},
                new String[]{
                        "ID","Name","Gender","Position","Email","Birthday"
                }
        ));
    ...
    public void Add(){
        try {
            ...
            if(IDexisted) {
                JOptionPane.showMessageDialog(this, "ID already existed!", "Error", JOptionPane.WARNING_MESSAGE);
            }else {
                ...
                if (sdf.format(bdate).equals(txtBday.getText())) {
                    ...
                    if(diffDays >= 18) {
                        ...
                        JOptionPane.showMessageDialog(this, "This candidate must greater than 18 years old!", "Error", JOptionPane.WARNING_MESSAGE);
                    }
                } else {
...
//        {
//            nof+= "\nYou must have fill in all the information bẻo adding";
//        }else{
//
//            //check ID
//            for (Manager M:list){
...
//        }
    ...
    public void updateCan(){
        ...
        c.setPosition(cbPosition.getSelectedItem().toString());
...
//    }
    ...
    public void showDetail(int row){
        ...
        //Boolean
        if(tbCan.getValueAt(row,2) == "Female"){
